...
ezplot(['(3*y)/4 - x - 7/4' ]) 
hold on
ezplot(['x + (6^(1/2)*y)/4 - (11*6^(1/2))/24 + 1/2' ]) 
hold on
ezplot(['- x - (6^(1/2)*y)/4 - 6^(1/2)/24 - 3/2' ]) 
hold on
...
figure
ezplot(['-x - 2*y - 4' ],[-25,5],[-3,13]) 
hold on
ezplot(['x + 2*y - 4' ],[-25,5],[-3,13]) 
hold on
ezplot(['48*x - 56*y + 4*x*y + x^2 + 4*y^2 - 184'],[-25,5],[-3,13]) 
hold on

ezplot(['2*y - x - 44' ],[-25,5],[-3,13]) 
hold on
ezplot(['x-9/5*y-5' ],[-25,5],[-3,13]) 
hold on
