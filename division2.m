...
t0a = (-psi01a-ma*psi02a)/(2*(psi11a+ma*psi12a));
t1a = 1/(2*(psi11a+ma*psi12a));
t2a = ma/(2*(psi11a+ma*psi12a));
gamma10a = t1a*(psi23a+qa*psi22a)/(psi11a+ma*psi12a);
gamma01a = t2a*(psi23a+qa*psi22a)/(psi11a+ma*psi12a);
gamma00a = (t0a*(psi23a+qa*psi22a)-psi13a-qa*(psi12a))/(psi11a+ma*psi12a);
...
zeta11a = -(psi11a*gamma10a+ma*psi12a*gamma10a)^2/(psi23a+qa*psi22a) + gamma10a
zeta12a = -(2*(psi11a*gamma01a+ma*psi12a*gamma01a)*(psi11a*gamma10a+ma*psi12a*gamma10a))/(psi23a+qa*psi22a) + gamma01a + ma *gamma10a
zeta22a = -(psi11a*gamma01a+ma*psi12a*gamma01a)^2/(psi23a+qa*psi22a) + gamma01a *ma

zeta10a = -2*(psi11a*gamma01a+ma*psi12a*gamma10a)*(psi13a+psi11a*gamma00a+psi12a*(qa+ma*gamma00a))/(psi23a+qa*psi22a) - ma*psi02a*gamma10a + gamma00a - psi01a*gamma10a;
zeta01a = -(2*(psi11a*gamma01a+ma*psi12a*gamma01a)*(psi13a+psi11a*gamma00a+psi12a*(qa+ma*gamma00a)))/((psi23a+qa*psi22a)) - ma*psi02a*gamma01a - psi01a*gamma01a + ma*gamma00a+qa;
zeta00a = -(psi13a+psi11a*gamma00a +psi12a*(qa+ma*gamma00a))^2/(psi23a+qa*psi22a) -psi03a - psi01a*gamma00a - psi02a*(qa+ma*gamma00a);

                 
D = zeta12^2 - 4*zeta11*zeta22
simplifyFraction(D)
%return
Da = zeta12a^2 - 4*zeta11a*zeta22a
simplifyFraction(Da)
...
fqa = simplifyFraction(zeta11a*s1^2 + zeta12a*s1*s2 + zeta22a*s2^2  + zeta10a*s1 + zeta01a*s2 + zeta00a)

temp = simplifyFraction(fq-fqa)
...
temp = simplifyFraction(cx(2)^2 - 4*cx(1)*cx(4))
subs(temp,m,ma)
...
zeta00a = (psi21a + ma*psi22a)^2  ;
delta1a = -2*(psi13a*psi21a - psi11a*psi23a + ma*psi13a*psi22a - ma*psi12a*psi23a - qa*psi11a*psi22a + qa*psi12a*psi21a)*(psi01a*psi21a + psi11a^2 + ma*(psi12a^2*ma + psi01a*psi22a + psi02a*psi21a + 2*psi11a*psi12a + psi02a*psi22a*ma))  ;
delta0a = 2*psi11a*psi23a*(psi11a+ma*psi12a) -2*psi13a*psi21a*(psi11a+ma*psi12a)-psi03a*psi21a*(psi21a+ma*psi22a)+ psi01a*psi23a*(psi21a+ma*psi22a) -2*ma*psi13a*psi22a*(psi11a+ma*psi12a) + 2*ma*psi12a*psi23a*(psi11a+ma*psi12a) - ma * psi03a*psi22a * (psi21a+ma*psi22a) + ma * psi02a*psi23a*(psi21a+ma*psi22a ) + 2*qa*psi11a*psi22a*(psi11a+ma*psi12a)- 2*qa*psi12a*psi21a* (psi11a+ma*psi12a) + qa*psi01a*psi22a*(psi21a+ma*psi22a)-qa*psi02a*psi21a*(psi21a+ma*psi22a);
si1a = 2*(psi21a + ma*psi22a) * (psi13a*psi21a - psi11a*psi23a + ma*psi13a*psi22a - ma*psi12a*psi23a - qa*psi11a*psi22a + qa*psi12a*psi21a)*s1 + 2*ma*(ma*psi22a + psi21a) * (psi13a*psi21a - psi11a*psi23a + ma*psi13a*psi22a - ma* psi12a*psi23a - qa*psi11a*psi22a + qa*psi12a*psi21a)*s2 + delta1a;
si1_2a = -(psi21a + ma*psi22a)*s1 -ma *(psi21a+ma*psi22a)*s2+psi01a*psi21a +psi11a^2 + ma*(ma*psi12a^2 + psi01a*psi22a+psi02a*psi21a+2*psi11a*psi12a+ma*psi02a*psi22a);
si0a = (-psi23a*(psi21a+ma*psi22a)-qa*psi22a*(psi21a+ma*psi22a))*s1 + (qa*psi21a*(psi21a+ma*psi22a)-ma*psi23a*(psi21a+ma*psi22a))*s2 + delta0a;  
...
% fractional quad
disp('frac-quad')
%fqa = a*s1^2+b*s1*s2+c*s2^2 +d*s1+e*s2+f
temp = simplifyFraction(((si1^2 / (zeta00^2 * si1_2))) -  (fqa-si0)^2)
temp = subs(temp,m,ma)
temp = subs(temp,q,qa)
[cx,tx] = coeffs(temp,[s1,s2]);
tx
...
%temp = simplifyFraction(((si1^2 / (zeta00^2 * si1_2))+(si1a^2 / (zeta00a^2 * si1_2a))-(si0a-si0)^2)^2 - (4*si1^2*si1a^2/(zeta00^2*zeta00a^2*(si1_2*si1_2a))))

temp = simplifyFraction(  si1^2 / (zeta00^2 * si1_2))  
temp = simplifyFraction(  temp + (si1a^2 / (zeta00a^2 * si1_2a)  ))
temp = simplifyFraction(  temp -(si0a-si0)^2)
temp = simplifyFraction(  temp ^2)
[cx,tx] = coeffs(temp,[s1,s2]);
tx

temp2 =  simplifyFraction((4*si1^2*si1a^2/(zeta00^2*zeta00a^2*(si1_2*si1_2a))))
[cx2,tx2] = coeffs(temp2,[s1,s2]);
tx2
for i = 1:size(cx,2)
  %cx(i)
  %cx2(i)
  cx3(i) = simplifyFraction(cx(i)-cx2(i));
  cx3(i)
  cx3(i) = subs(cx3(i),m,ma);
  cx3(i) = subs(cx3(i),q,qa);
  cx3(i)
end 
return
temp =  simplifyFraction(temp - temp2)
[cx,tx] = coeffs(temp,[s1,s2]);
tx
%coeffs(cx(3),s1)
%coeffs(cx(3),s2)
